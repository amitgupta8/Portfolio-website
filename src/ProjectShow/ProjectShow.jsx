  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute left-1/2 top-[-250px] h-[450px] w-[600px] -translate-x-1/2 rounded-full bg-indigo-600/[0.07] blur-[130px]" />

        <div className="absolute left-[-220px] top-[40%] h-[280px] w-[280px] rounded-full bg-blue-600/[0.035] blur-[100px]" />

        <div className="absolute bottom-[-150px] right-[-180px] h-[330px] w-[330px] rounded-full bg-purple-600/[0.035] blur-[110px]" />
      ...
      <div className="relative z-10 mx-auto max-w-5xl">
        ...
        <div className="mx-auto mb-9 max-w-xl text-center sm:mb-11">

          <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-indigo-400/10 bg-indigo-500/[0.05] px-3 py-1.5 text-[9px] font-bold tracking-[0.18em] text-slate-400 backdrop-blur-xl">
          ...
          <div className="mx-auto mt-5 flex items-center justify-center gap-2">
            ...
            <span className="h-1.5 w-1.5 rounded-full bg-indigo-400 shadow-[0_0_10px_rgba(99,102,241,.8)]" />
          ...
          {PROJECTS.map((project) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`absolute -inset-[1px] rounded-[18px] bg-gradient-to-r ${project.gradient} opacity-0 blur-md transition-all duration-500 group-hover:opacity-35`}
                />
                ...
                <div
                  ...
                  className="relative cursor-pointer overflow-hidden rounded-[18px] border border-white/[0.07] bg-[#080d19] shadow-[0_10px_35px_rgba(0,0,0,.22)] transition-all duration-300 group-hover:-translate-y-1.5 group-hover:border-white/[0.13] group-hover:shadow-[0_18px_45px_rgba(0,0,0,.32)]"
                >
                  {/* Top Gradient */}
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex h-7 w-7 items-center justify-center rounded-lg border border-white/[0.07] bg-white/[0.025] text-indigo-400 transition-all duration-300 group-hover:translate-x-1 group-hover:border-indigo-400/20 group-hover:bg-indigo-500/10">
        ...
        <p className="mt-8 text-center text-[9px] text-slate-700 sm:text-[10px]">
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center overflow-y-auto bg-black/75 p-3 backdrop-blur-md sm:p-5">
          ...
          <div className="relative z-10 my-4 max-h-[92vh] w-full max-w-md overflow-y-auto rounded-[22px] border border-white/[0.09] bg-[#080d19] shadow-[0_25px_70px_rgba(0,0,0,.65)]">
